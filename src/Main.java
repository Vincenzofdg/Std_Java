...
public class Main {
    public static void main(String[] args) {
        ...
        newFilm.setDescription("n the Second Age of Middle-earth, the lords of Elves, Dwarves, and Men are given Rings of Power. Unbeknownst to them, the Dark Lord Sauron forges the One Ring in Mount Doom, instilling into it a great part of his power to dominate the other Rings and conquer Middle-earth.");
        newFilm.setReleaseYear(2001);
        newFilm.setOnPlan(true);
        newFilm.setRate(9.7F);
